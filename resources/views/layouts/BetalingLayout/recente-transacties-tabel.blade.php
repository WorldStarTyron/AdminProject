        ...
        <table class="w-full text-left table-fixed">
            ...
            <thead>
                <tr class="bg-slate-50/80">
                    ...
                    <th class="px-4 py-3 text-[0.625rem] font-bold text-slate-400 uppercase tracking-wider">Actie</th>
                    @can('betalingen-beheren')
                    <th class="px-4 py-3 text-[0.625rem] font-bold text-slate-400 uppercase tracking-wider"></th>
                    @endcan
                </tr> 
            </thead>
            <tbody class="divide-y divide-slate-100/80">
                ...
                <tr class="hover:bg-slate-50/60 transition-colors group">
                    ...
                    <td class="px-4 py-3.5 text-center">
                        <button
                            class="edit-betaling-btn opacity-0 group-hover:opacity-100 w-7 h-7 rounded-lg bg-slate-100 hover:bg-blue-50 hover:text-blue-600 text-slate-400 flex items-center justify-center transition-all duration-150 mx-auto"
