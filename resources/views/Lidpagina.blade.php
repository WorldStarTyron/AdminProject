                        ...
                        <div class="flex items-start gap-6 flex-1">
                            ...
                            <div class="flex flex-col gap-3 pt-1">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="inline-flex items-center px-3 py-1 rounded-full bg-gradient-to-r from-cyan-500 to-teal-500 text-white text-xs font-bold tracking-wide shadow-sm">LID #9</span>
                                </div>
                            ...
                            <table class="w-full text-sm" id="paymentHistoryTable">
                                ...
                                <tbody class="divide-y divide-slate-50">
                                    <tr class="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td class="px-6 py-4"><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold tracking-wide bg-emerald-50 text-emerald-600">BETAALD</span></td>
                                    ...
                                    <tr class="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 text-slate-700 font-medium">SRD 45.00</td>
                                        <td class="px-6 py-4"><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold tracking-wide bg-red-50 text-red-600">NIET BETAALD</span></td>
                                        <td class="px-6 py-4 text-slate-500">—</td>
                                    </tr>
                                    <tr class="hover:bg-slate-50/50 transition-colors">
