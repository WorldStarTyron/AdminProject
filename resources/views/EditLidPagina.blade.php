...
<head>
    ...
    {{-- Make sure Tailwind is included via app.css or add the CDN below for dev only --}}
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="date" name="lid_sinds" id="lid_since" value="{{ old('lid_since', $lid->lid_since) }}" required class="w-full px-3 py-2.5 text-sm text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-300 focus:border-slate-400 transition-all">
                                        </div>
                                    </div>
                                </div>
