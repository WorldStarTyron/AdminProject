...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/css/sidebar.css', 'resources/css/totalleden.css', 'resources/css/Toevoegen.css', 'resources/js/app.js'])
            ...
            <div class="table-container">
                ...
                <div class="table-header-top">
                    ...
                    <div class="table-actions">
                        ...
                        <button class="btn-filter" id="filterBtn" title="Filter opties">
